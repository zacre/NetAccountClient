 ...
 * </p>
 * <p>
 * Modified by Robert Egglestone to support 64-bit as per:
 * https://issues.jboss.org/browse/JBIDE-12829
 * </p>
 */
public class CocoaUIEnhancer {
     ...
     */
    public void hookApplicationMenu( Display display, final Runnable aboutAction,
        ...
        //
        ActionCallback target = new ActionCallback() {
    ...
    private void initialize( ActionCallback callbackObject )
            throws Exception {
    ...
    private static abstract class ActionCallback {

        // 64-bit version
        public abstract long actionProc(long id, long sel, long arg0);
